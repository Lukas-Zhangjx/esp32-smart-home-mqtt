...
//wifi information config
    /* C++ does not support nested designated initializers (.threshold.authmode),
     * so authmode threshold is assigned separately after zero-initialization. */
    ...
    /* Authmode threshold resets to WPA2 as default if password matches WPA2 standards (len >= 8).
     * For deprecated WEP/WPA networks, set ESP_WIFI_SCAN_AUTH_MODE_THRESHOLD accordingly. */
